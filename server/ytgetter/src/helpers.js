...
exports.dargs = exports.parse = exports.isJSON = exports.args = void 0;
const args = (url, flags = {}) => [].concat(url, dargs(flags, { useEquals: false })).filter(Boolean);
exports.args = args;
const isJSON = (str) => str.startsWith("{");
exports.isJSON = isJSON;
const parse = ({ stdout }) => exports.isJSON(stdout) ? JSON.parse(stdout) : stdout;
exports.parse = parse;
...
function dargs(object, options) {
    ...
    options = Object.assign({ useEquals: true, shortFlag: true }, options);
